                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                          <a href="tambahbank.php">
                            <p class="text-primary m-0 font-weight-bold">Tambah Data Bank</p>
                          </a>
                        </div>
                        <div class="card-body">
                            <!--<div class="row">-->
                                    ...
                                    <tbody>
                                        ...
                                        while($stmt->fetch()){
                                          ...
                                          echo "<tr>
                                              ...
                                              <td>".$kode_bank."</td>
                                              <td>".$norek."</td>
                                              <td><a href='editbank.php?id=$id'>Edit</a><br><a href='deletebank.php?id=$id'>Delete</a></td>
                                                </tr>";
                                        }
