                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                              <form method="post" action="tambahkamar_proc.php">
                                <table>

                                    <tr><td>Nomor Kamar</td><td><input type="text" name="nomorkamar"></td></tr>
                                    <tr><td>Luas Kamar</td><td><input type="text" name="luaskamar"></td></tr>
