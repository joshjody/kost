                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                              <form method="post" action="editbank_proc.php?id=$id">
                                <table>
                                    <?php
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM `bank` WHERE id=$id");
                                    $stmt->execute();
                                    $stmt->bind_result($id, $nama_bank, $kode_bank, $norek);
                                    while($stmt->fetch()){


                                      echo "

                                      <tr><td>Nama Bank</td><td><input type='text' name='namabank' value=".$nama_bank."></td></tr>
                                      <tr><td>Kode Bank</td><td><input type='text' name='kodebank' value=".$kode_bank."></td></tr>
                                      <tr><td>Nomor Rekening</td><td><input type='number' name='norek' value=".$norek."></td></tr>
