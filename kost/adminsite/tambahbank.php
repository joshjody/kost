                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                              <form method="post" action="tambahbank_proc.php">
                                <table>

                                    <tr><td>Nama Bank</td><td><input type="text" name="namabank"></td></tr>
                                    <tr><td>Kode Bank</td><td><input type="text" name="kodebank"></td></tr>
                                    <tr><td>Nomor Rek</td><td><input type="text" name="norek"></td></tr>
