                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                              ...
                              $id           = $_GET['id'];
                              echo'
                              <form method="post" action="edituser_proc.php?id='.$id.'">
                              ';
                              ?>
                                <table>
                                    <?php
                                    ...
                                    $stmt->execute();
                                    $stmt->bind_result($id, $nama, $jenkel, $alamat, $noktp, $email, $notelf, $username, $password);
                                    while($stmt->fetch()){
                                      ...
                                      <tr><td>Jenis Kelamin</td>
                                        <td>
                                          <select name='JenisKelamin' value=".$jenkel.">
                                      ...
                                      <tr><td>Nomor KTP</td><td><input type='text' name='nomorktp' value=".$noktp."></td></tr>
                                      <tr><td>Email</td><td><input type='email' name='email' value=".$email."></td></tr>
                                      <tr><td>No Telf</td><td><input type='text' name='notelf' value=".$notelf."></td></tr>
